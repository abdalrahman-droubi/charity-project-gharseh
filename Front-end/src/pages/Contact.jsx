  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            'url(https://www.learnfirstaid.ca/wp-content/uploads/2022/10/contact-pagebanner.jpg)',
          height: "400px",
        }}
        dir="rtl"
      >
            ...
            <div className="mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full  lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0" style={{ marginRight: "60px", marginLeft: "65px" }}>
                  <h2 className="text-green-500 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                      تواصل معنا
                  </h2>
                  <h4 className="text-body-color font-bold mb-9 text-base leading-relaxed">
                    إذا كان لديك أي أسئلة أو تشعر بالارتباك بشأن شيء ما،
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      <h4 className="text-green-800 mb-1 text-xl font-bold">
                        موقعنا
                      </h4>
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div className="relative rounded-lg bg-green-300 p-8 shadow-lg sm:p-12">
                  <form method="post"  onSubmit={handleSubmit}>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="bg-green-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        ارسل رسالة
                      </button>
                    </div>
